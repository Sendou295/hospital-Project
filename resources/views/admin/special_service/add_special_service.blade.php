        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/save-special_service')}}" method="POST">
                        {{ csrf_field() }}
                    <div class="form-group">
                        <label for="exampleInputEmail1">Special Service Name</label>
                        <input type="text" name="special_service_name" class="form-control" id="exampleInputEmail1" required="" placeholder="special_service name"> 
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Special Service Description</label>
                        <textarea style="resize:none" rows="5" type="text" name="special_service_desc" class="form-control" id="exampleInputPassword1" required="" placeholder="special_service introduction"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{URL::to('public/upload/special_service/'.$special_service->special_service_image)}}" height="100" width="100">
                    </div>
                    <div class="form-group">
