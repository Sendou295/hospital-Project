        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><td>{{$base->base_name}}</td></td>
                        <td><td>{{$base->base_address}}</td></td>
                        <td><td>{{$base->base_phone}}</td></td>
                        <td><img src="public/upload/base/{{$base->base_image}}" height="100" width="100">{{$base->base_image}}</td>
