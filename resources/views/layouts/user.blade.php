...
<body>
    <div class="row">
        ...
        <nav class="col-4 nav-bar">
            <div class="vertical-navbar">
                ...
                <ul id="nav-menu">
                    ...
                    <li><a href="{{ URL::to('/shop') }}">Chuyên Khoa</a></li>
                    <li><a href="{{ URL::to('/shop') }}">Chuyên Gia & Bác Sĩ</a></li>
                    <li><a href="{{ URL::to('/shop') }}">Dịch vụ đặc biệt</a></li>
                    <li><a href="{{ URL::to('/shop') }}">Tiện nghi</a></li>
                    <li><a href="{{ URL::to('/shop') }}">Thành Tựu</a></li>
                    <li><a href="{{ URL::to('/shop') }}">News +</a></li>
                    <li><a href="{{ URL::to('/shop') }}">Contact</a></li>
                </ul>
    
                <div class="nav-connect-link">
                    <a href="https://www.facebook.com/"><i class="fab fa-facebook fa-2x" style="color: #2D3791"></i></a>
                    <a href="https://www.youtube.com/"><i class="fab fa-youtube fa-2x" style="color: #FF0000"></i></a>
                    <a href="https://www.google.com/"><i class="fab fa-google fa-2x" style="color: #3F7FE9"></i></a>
                </div>
        ...
        <div class="col-9 page-content">
            ...
            <div class="header">
                <div class="header-account">
                    <div class="header-register">
                        <a href=""><img src="img/icon/user-plus-solid.svg" alt="">Register</a>
                    </div>
                    <div class="header-login">
                        <a href=""><img src="img/icon/right-to-bracket-solid.svg" alt="">Login</a>
                    </div>
                </div>
            ...
            <!-- Banner -->
            <div class="banner">
                <img class="image" src="img/Banner1.png" alt="quotes">
            </div>
