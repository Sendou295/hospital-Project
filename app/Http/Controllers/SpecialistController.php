...
class SpecialistController extends Controller
{
    ...
    public function add_specialist(){
        ...
        // $specialist_base = DB::table('tbl_bases')->orderby('base_id','desc')->get();
        $data['base'] = tbl_bases::get(["base_name","base_id"]);
        $data['department'] = tbl_departments::get(["department_name","department_id"]);
        // $specialist_department = DB::table('tbl_departments')->orderby('department_id','desc')->get();
        // return view('admin.specialist.add_specialist',compact('specialist_base'))
        // ->with('specialist_position', $specialist_position);
        return view('admin.specialist.add_specialist',$data)
        ->with('specialist_position', $specialist_position);
        // ->with('specialist_department', $specialist_department)
        // ->with('specialist_base', $specialist_base);
    ...
    public function get_Department(Request $request)
    {
        ...
        // $specialist_department = DB::table('tbl_departments')->where("base_id", $request->base_id)->get(["department_name","department_id"]);
        // $data['tbl_departments'] = DB::table('tbl_departments')->where("base_id", $request->base_id)->get(["department_name","department_id"]);
        $data['department'] = tbl_departments::where("base_id", $request->base_id)->get(["department_name","department_id"]);
