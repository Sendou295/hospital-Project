...
class SpecialServiceController extends Controller
{
    ...
    public function add_special_service(){
        ...
        $special_service_department = DB::table('tbl_department')->orderby('department_id','desc')->get();
    ...
    public function all_special_services(){
        ...
        ->join('tbl_department','tbl_department.department_id','=','tbl_special_service.department_id')
