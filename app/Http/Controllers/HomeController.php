...
class HomeController extends Controller
{
    ...
    $specialist_base = DB::table('tbl_bases')->where('base_status','1')->orderby('base_id','desc')->get();
    $specialist_department = DB::table('tbl_departments')->where('department_status','1')->orderby('department_id','desc')->get();
    ...
    $all_specialists = DB::table('tbl_specialist')->where('specialist_status','1')
        ->join('tbl_bases','tbl_bases.base_id','=','tbl_specialist.base_id')
        ->join('tbl_departments','tbl_departments.department_id','=','tbl_specialist.department_id')
